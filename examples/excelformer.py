...
def gen_best_result_report(filename):
    ...
    data = {
        ...
        'Difference 1': [float(best_val_result_metric_1)-float(best_val_result_metric_2) for best_val_result_metric_1,best_val_result_metric_2 in zip(best_val_result_metrics_1,best_val_result_metrics_2)],
        'Difference 2': [float(best_test_result_metric_1)-float(best_test_result_metric_2) for best_test_result_metric_1,best_test_result_metric_2 in zip(best_test_result_metrics_1,best_test_result_metrics_2)]
    }
